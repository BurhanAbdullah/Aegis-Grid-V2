...
REPLACEMENTS = [
    ...
    ("The present manuscript therefore does not retain the earlier claims of FPR below $0.6\\%$ or recall of $85.85\\%$ as authoritative results for this run.", "The present manuscript does not retain the earlier archived claims of sub-$0.6\\%$ FPR or the earlier high-recall aggregate as authoritative results for this run."),
