...
This manifest inventories the 12 publication figures generated by the validation pipeline. Figures 2 and 12 are regenerated explicitly from the current validation outputs by `scripts/regenerate_publication_figures.py`.
...
| **Fig. 11** | Computational scaling experiment | `robustness_results.csv` | Regenerated timing experiment | VERIFIED |
